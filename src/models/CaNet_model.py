...
from src.utils.data_utils import sys_normalized_adjacency, sparse_mx_to_torch_sparse_tensor
...
class CaNet(nn.Module):
    ...
    def forward(self, x, adj, batch, idx=None, training=False):
    ...
    def loss_compute(self, d, criterion, args):
        logits, reg_loss = self.forward(d.x, d.edge_index, batch=d.batch, idx=None, training=True)
        sup_loss = self.sup_loss_calc(d.y, logits, criterion, args)
